        ...
        <section class="panel panel-with-borders">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="po" placeholder="Nomor Invoice"/>
                    </div>
                </div>           
                <table class="table table-hover editable-table">
                        ...
                        <tbody id="barang">
                            <tr>
                                <td>
                                    <select class="form-control" placeholder="Pilih PO" onchange="gantibarangPO('',this)">
                                        <option value="" selected="selected">Nomor PO</option>
                                        <?php
                                        foreach($po->result() as $c){
                                            echo '<option value="'.$c->id.'">'.$c->no_po.'</option>';
                                        }
                                        ?>
                                    </select>
                                </td>
...
function gantibarangPO(idbarang,val){
    id = val.value;
    $.ajax({
        url: "<?=base_url()?>ajax/barangPO/"+id,
        context: document.body
    }).done(function(data) {
