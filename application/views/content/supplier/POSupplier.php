    ...
    <div class="page-content-inner">
        <section class="panel panel-with-borders">
            <div class="panel-heading">
               <a class="btn btn-rounded btn-success-outline margin-inline" style="float:right" href="<?=@site_url('supplier/po/add')?>" ><i class="icmn-plus3"> </i>Tambah PO</a>
                    ...
                    <?php
                        foreach($po->result() as $p){
                            ...
                            echo "<tr>
                                    ...
                                    $status
                                    <td><input id=\"status$p->id\" type=\"hidden\" value=\"$p->status\"> <a href=\"".base_url()."supplier/po/$p->id/download\" class=\"btn btn-success\">Download</a> <a onclick=\"update('$p->id')\" class=\"btn btn-success\">Update Status</a> 
                                    </td>                                    
                                </tr>";
                        }
                    ?>
